# Arquivo: backend/app/crud/crud_noticias.py

from motor.motor_asyncio import AsyncIOMotorDatabase
from typing import List, Optional
from bson.objectid import ObjectId
from ..models.schemas import NoticiaCreate, Noticia
from fastapi import HTTPException, status # Usado para exceção no is_db_active
